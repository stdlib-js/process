...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/process@v0.3.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/process@v0.3.2-umd/browser.js"></script>
```
